...
const STATE_MAX = 3; // don't look in any states
const CITIES_MAX = 7; // look in the top 10 largest cities

const cities = [ "New York, New York", "Philadelphia, Pennsylvania", "Baltimore, Maryland",
		"Washington, District of Columbia","Virginia Beach, Virginia", "Norfolk, Virginia", "Chesapeake, Virginia"
];
